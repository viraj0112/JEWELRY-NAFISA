...
class CreatorsUploadedWorksTab extends StatelessWidget {
  final List<WorkModel>
      works; // We ignore this input effectively and use provider directly for filtering
  final List<CreatorModel> creators;

  const CreatorsUploadedWorksTab(
      {super.key, required this.works, required this.creators});
      ...
      child: LayoutBuilder(builder: (context, constraints) {
        ...
        return GridView.builder(
          ...
          itemBuilder: (context, idx) {
            final w = list[idx];
            final creator = creators.firstWhere((c) => c.id == w.creatorId,
                orElse: () => CreatorModel(
                      id: 'unknown',
                      fullName: 'Unknown',
                      email: null,
