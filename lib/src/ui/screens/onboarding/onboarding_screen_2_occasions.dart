            ...
            children: [
              IconButton(
                ...
                icon: Icon(Icons.arrow_back_rounded,
                    color: colorScheme
                        .onBackground), // FIX: Use onBackground for icon color
                iconSize: 28,
              ),
              const Spacer(),
              ...
              Text(
                ...
                style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                      ...
                      color: colorScheme.onBackground
                          .withOpacity(0.6), // FIX: Use onBackground
                    ),
              ),
            ],
          ),
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            ...
            color:
                isSelected ? cardColor : colorScheme.onSurface.withOpacity(0.1),
        ...
        boxShadow: [
          BoxShadow(
            color: colorScheme.onSurface
                .withOpacity(0.1), // FIX: Use onSurface for shadow
            blurRadius: 10,
