...
CREATE TABLE IF NOT EXISTS public."designer-files" (
...
DROP POLICY IF EXISTS "Designers can manage their own files" ON public."designer-files";
...
DROP POLICY IF EXISTS "Admins have full access to designer files" ON public."designer-files";
