          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: const Color(0xFFF5E6B0).withValues(alpha: 0.5),
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: _kLightGold.withValues(alpha: 0.5),
  ...
  Widget _buildUploadCard({
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isSelected ? _kDeepGreen.withValues(alpha: 0.04) : Colors.white,
...
class _DiamondPatternPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()
      ..color = const Color(0xFFB8860B).withValues(alpha: 0.045)
      ..strokeWidth = 1
