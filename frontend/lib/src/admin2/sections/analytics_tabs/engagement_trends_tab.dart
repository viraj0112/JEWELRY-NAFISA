          ...
          child: DataTable(
            ...
            columns: [
              ...
              DataColumn(
                label: Row(
                  children: [
                    const EngagementIcon(type: 'views', color: Colors.blue),
              ...
              DataColumn(
                label: Row(
                  children: [
                    const EngagementIcon(type: 'likes', color: Colors.red),
                    const SizedBox(width: 8),
                    SortableTableHeader(
                      title: 'Likes',
              ...
              DataColumn(
                label: Row(
                  children: [
                    const EngagementIcon(type: 'comments', color: Colors.green),
                    const SizedBox(width: 8),
                    SortableTableHeader(
                      title: 'Comments',
              ...
              DataColumn(
                label: Row(
                  children: [
                    const EngagementIcon(type: 'saves', color: Colors.orange),
                    const SizedBox(width: 8),
                    SortableTableHeader(
                      title: 'Saves',
