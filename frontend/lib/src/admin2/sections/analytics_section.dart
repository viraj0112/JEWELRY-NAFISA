...
class _AnalyticsSectionState extends ConsumerState<AnalyticsSection> {
      ...
      child: Column(
        children: [
          SectionHeader(
            ...
            gradientColors: const [Color(0xFFf3e8ff), Color(0xFFfce7f3)],
  ...
  Widget _buildEngagementTrendChart(List<EngagementTrend> trends) {
    ...
    const currentColor = Color(0xFFec4899);
    const previousColor = Color(0xFF0ea5e9);
        ...
        child: DataTable(
          ...
          columns: [
            ...
            DataColumn(
              label: Row(
                children: [
                  const EngagementIcon(type: 'views'),
            ...
            DataColumn(
              label: Row(
                children: [
                  const EngagementIcon(type: 'likes'),
                  const SizedBox(width: 8),
                  SortableTableHeader(
                    title: 'Likes',
                    onTap: () {},
            ...
            DataColumn(
              label: Row(
                children: [
                  const EngagementIcon(type: 'comments'),
                  const SizedBox(width: 8),
                  SortableTableHeader(
                    title: 'Comments',
                    onTap: () {},
            ...
            DataColumn(
              label: Row(
                children: [
                  const EngagementIcon(type: 'saves'),
                  const SizedBox(width: 8),
                  SortableTableHeader(
                    title: 'Saves',
                    onTap: () {},
      ...
      child: Column(
        children: [
          SectionHeader(
            ...
            gradientColors: const [Color(0xFFdbeafe), Color(0xFFe0e7ff)],
      ...
      child: Column(
        children: [
          SectionHeader(
            ...
            gradientColors: const [Color(0xFFfef3c7), Color(0xFFfed7aa)],
        ...
        SingleChildScrollView(
          ...
          child: ConstrainedBox(
            ...
            child: DataTable(
              headingRowColor: WidgetStateProperty.all(Colors.grey.shade50),
              columns: const [
                DataColumn(label: SizedBox(width: 48)), // Checkbox column
                DataColumn(
                    label: Text('Username',
                        style: TextStyle(fontWeight: FontWeight.w600))),
                DataColumn(
