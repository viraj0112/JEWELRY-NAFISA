...
class ReferralLeaderboardTab extends StatelessWidget {
  const ReferralLeaderboardTab({super.key});
          ...
          trailing: SizedBox(
            ...
            child: Column(
                ...
                children: [
                  ...
                  Text('${(item.successRate * 100).toStringAsFixed(0)}%',
...
class _RankWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return CircleAvatar(
        backgroundColor: Colors.grey.shade200, child: Text('#$rank'));
  }
}
