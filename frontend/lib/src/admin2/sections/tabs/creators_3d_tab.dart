...
// Used to display mini work cards in dialog
...
class Creators3DTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final list = provider.filteredCreators.where((c) {
      ...
      final has3DWork = provider.works
          .any((w) => w.creatorId == c.id && w.category == '3D Model');
  ...
  void _showSubmissionDetails(
      BuildContext context, CreatorModel creator, CreatorsProvider provider) {
      ...
      builder: (context) => AlertDialog(
        ...
        content: SizedBox(
          ...
          child: Column(
            ...
            children: [
              Text('Pending Approval: ${pendingWorks.length} items',
