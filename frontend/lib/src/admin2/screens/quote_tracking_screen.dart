          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                const Expanded(flex: 3, child: _HeaderCell('USER')),
                const Expanded(flex: 2, child: _HeaderCell('CREATOR')),
                const Expanded(flex: 3, child: _HeaderCell('PRODUCT / DESIGN')),
                const Expanded(flex: 2, child: _HeaderCell('DATE')),
                const Expanded(flex: 2, child: _HeaderCell('STATUS')),
                const SizedBox(width: 48, child: _HeaderCell('ACTIONS')),
              ],
            ),
          ),
...
class _QuoteDetailDialogState extends State<_QuoteDetailDialog> {
  ...
  Widget _buildCalculator() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFFE8EEE9).withValues(alpha: 0.4),
