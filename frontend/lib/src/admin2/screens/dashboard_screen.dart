...
class _DashboardScreenState extends ConsumerState<DashboardScreen> {
  ...
  // These two were physically located inside _RealtimeSparklineCard, which
  // is a StatelessWidget - so they could not see selectedMetalView,
  // selectedMetalSource, context or setState and the file did not compile.
  // They are members of this State class; moved back where they belong.
              ...
              Row(
                children: [
                  ...
                  SizedBox(
                    ...
                    height: 40,
                    child: DropdownButtonFormField<String>(
                      initialValue: selectedMetalSource,
                      decoration: InputDecoration(
                        contentPadding:
