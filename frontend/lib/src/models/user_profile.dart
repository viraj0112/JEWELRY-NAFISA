...
// --------------------------------------------------------------------------
  factory UserProfile.fromMap(Map<String, dynamic> map) {
    ...
    DesignerProfile? parseDesignerProfile(dynamic data) {
    ...
    ManufacturerProfile? parseManufacturerProfile(dynamic data) {
      if (data == null) return null;
      if (data is List && data.isNotEmpty) {
    ...
    return UserProfile(
      ...
      designerProfile: parseDesignerProfile(designerProfileData),
      manufacturerProfile: parseManufacturerProfile(manufacturerProfileData),
      bio: map['bio'],
