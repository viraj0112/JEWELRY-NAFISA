...
class JewelryItem {
  ...
  final List<String>? stoneQuality;
  /// Set by the AI-fill backend when it writes any field of this product.
  final DateTime? aiFilledAt;
  /// When the product was uploaded (row `created_at`).
  final DateTime? createdAt;
  /// Every field AI has filled on this product.
  final List<String>? aiFilledColumns;
  bool get isAiFilled => aiFilledAt != null;
  // --- END MODIFICATION ---
  ...
  factory JewelryItem.fromJson(Map<String, dynamic> json) {
    ...
    return JewelryItem(
      ...
      stoneQuality: _parseList(json['Stone Quality'] ?? json['stone_quality']),
      aiFilledAt: json['ai_filled_at'] == null
          ? null
          : DateTime.tryParse('${json['ai_filled_at']}'),
      aiFilledColumns: _parseList(json['ai_filled_columns']),
