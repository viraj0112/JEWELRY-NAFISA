        ...
        child: SingleChildScrollView(
          ...
          child: Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("Bulk Upload", style: B2BText.serif(size: 26)),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
          onTap: onTap,
          child: CustomPaint(
            painter: _DottedBorderPainter(color: B2BColors.border),
            child: Container(
              height: 200,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: const TextStyle(fontSize: 13, color: B2BColors.muted),
...
class _ColumnChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Text(label,
          style: const TextStyle(fontSize: 12, color: B2BColors.inkSoft)),
    );
  }
}
