          ...
          child: Row(
            children: [
              Container(
                ...
                child:
                    const Icon(Icons.upload_outlined, color: B2BColors.primary),
              ),
...
class _Bullet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        const Icon(Icons.circle, size: 6, color: B2BColors.primary),
...
class _ProductUploadWizardState extends State<ProductUploadWizard> {
  ...
  final List<Uint8List> _allImageBytes = [];
    ...
    switch (step) {
      case 0:
        return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text('Upload Images', style: B2BText.serif(size: 22)),
      ...
      case 1:
        return Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Product Details', style: B2BText.serif(size: 22)),
            const SizedBox(height: 8),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Switch(
                    value: customizable,
                    activeThumbColor: B2BColors.primary,
      ...
      case 2:
        return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text('Visibility Settings', style: B2BText.serif(size: 22)),
          const SizedBox(height: 8),
  ...
  Widget _buildReviewStep() {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Text('Review & Publish', style: B2BText.serif(size: 22)),
      const SizedBox(height: 8),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        TextField(
          ...
          decoration: InputDecoration(
            isDense: true,
            hintText: hintText,
            hintStyle: const TextStyle(color: B2BColors.faint, fontSize: 14),
            ...
            border: OutlineInputBorder(
                ...
                borderSide: const BorderSide(color: B2BColors.border)),
    ...
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        DropdownButtonFormField(
            ...
            hint: hintText != null
                ? Text(hintText,
                    style: const TextStyle(color: B2BColors.faint, fontSize: 14))
                : null,
            decoration: InputDecoration(
              isDense: true,
              contentPadding:
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
              color:
                  isSelected ? B2BColors.primary : B2BColors.border,
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(subtitle,
                      style:
                          const TextStyle(color: B2BColors.muted, fontSize: 13)),
                ],
              ),
            )
          ],
  ...
  Widget _reviewItem(String label, String value) {
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          Text(label,
              style: const TextStyle(color: B2BColors.muted, fontSize: 13)),
          const SizedBox(height: 4),
          Text(value,
              style:
  ...
  Widget _buildUploadBox({bool isSmall = false}) {
    return GestureDetector(
      onTap: _pickImages,
      child: CustomPaint(
        painter: _DottedBorderPainter(color: B2BColors.faint),
        child: Container(
  ...
  Future<void> _publishProduct() async {
    ...
    try {
      ...
      // No row (or no embedded manufacturer profile) means "not a
      // manufacturer", which routes the upload to the designer bucket - the
      // same outcome as before, minus the thrown exception.
            ...
            child: SizedBox(
                ...
                child: ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    ...
                    disabledBackgroundColor: B2BColors.border,
                    disabledForegroundColor: B2BColors.muted,
                  ),
...
class _DottedBorderPainter extends CustomPainter {
  final Color color;
  // Defaults were constructor params until `dart fix` removed them as
  // unused; the fields are still read in paint(), so keep the same values.
