...
class HomeScreenState extends State<HomeScreen> {
  ...
  // Filter options
  final List<String> _metalTypeOptions = ['All', 'Gold', 'Silver', 'Platinum'];
  ...
  final List<String> _plainOptions = [];
  final List<String> _studdedOptions = [];
    ...
    return Theme(
      ...
      body: FloatingFilterOverlay(
        config: FloatingFilterConfig(
          ...
          metalTypeOptions:
              {'All', ..._metalTypeOptions, 'Instant'}.toList(),
      ...
      switch (metalType) {
        ...
        case 'Platinum':
          decoration = BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: const Color(0xFFD3D3D3).withValues(alpha: 0.25),
                blurRadius: 3,
                offset: const Offset(0, 1.5),
              ),
            ],
      ...
      children: [
        ...
        ...options.map((option) {
          ...
          return FilterChip(
            ...
            selectedColor: B2BColors.primary,
          ...
          children: [
            ...
            if (isMember) ...[
              Padding(
                ...
                child: Text(
                  item.productTitle,
                  style: B2BText.serif(size: 13.5, weight: FontWeight.w700),
                  maxLines: 1,
