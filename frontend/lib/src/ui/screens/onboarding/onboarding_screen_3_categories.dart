...
class _OnboardingScreen3CategoriesState
  ...
  final List<Map<String, dynamic>> categoryOptions = [
    ...
    },
    {
      'name': 'Necklaces',
      'image':
          'https://images.unsplash.com/photo-1635767798638-3e25273a8236?q=80&w=764&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      'gradient': [const Color(0xFF4A9D6F), const Color(0xFF66BB94)],
    },
    {
      'name': 'Earrings',
      'image':
          'https://images.unsplash.com/photo-1561172478-a203d9c8290e?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      'gradient': [const Color(0xFF2E7D52), const Color(0xFF52A876)],
    },
    {
      'name': 'Bracelets',
      'image':
          'https://images.unsplash.com/photo-1619119069152-a2b331eb392a?q=80&w=1171&auto=format&fit:crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    ...
    },
    {
      'name': 'Custom Design',
      'image':
          'https://images.unsplash.com/photo-1692421098809-6cdfcfea289a?q=80&w=880&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  ...
  Color _getColorForGradient(Color primary, int index) {
    ...
    if (Theme.of(context).brightness == Brightness.dark) {
      ...
      return Color.lerp(primary.withValues(alpha: 0.5), primary, t)!;
    } else {
      // Interpolate towards a slightly darker shade in Light Mode
      return Color.lerp(primary, primary.withValues(alpha: 0.5), t)!;
    }
  }
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                ...
                color:
                    colorScheme.onSurface.withValues(alpha: isSelected ? 0.2 : 0.08),
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      ...
                      colors: [
                        gradientStart,
                        gradientEnd
                      ], // Using dynamic theme-aware colors
                    ),
                  ),
                ),
                ...
                CachedNetworkImage(
                  ...
                  color: theme.brightness == Brightness.dark
                      ? Colors.black.withValues(alpha: 
                          0.2) // Subtle darkening of image in Dark Mode
                      : null,
