            ...
            children: [
              IconButton(
                ...
                icon: Icon(Icons.arrow_back_rounded,
                    color: colorScheme
                        .onSurface), // FIX: Use onBackground for icon color
                iconSize: 28,
              ),
              const Spacer(),
              ...
              Text(
                ...
                style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                      ...
                      color: colorScheme.onSurface
                          .withValues(alpha: 0.6), // FIX: Use onBackground
                    ),
              ),
            ],
          ),
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            ...
            color:
                isSelected ? cardColor : colorScheme.onSurface.withValues(alpha: 0.1),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                color: isSelected
                    ...
                    : colorScheme.surface, // Inner circle background
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: colorScheme.onSurface
                .withValues(alpha: 0.1), // FIX: Use onSurface for shadow
            blurRadius: 10,
