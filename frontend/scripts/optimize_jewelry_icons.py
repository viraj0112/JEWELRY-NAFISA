...
Run once:  python frontend/scripts/optimize_jewelry_icons.py  (from any directory)
...
# Paths are relative to the Flutter app root (frontend/).
APP_ROOT = pathlib.Path(__file__).resolve().parent.parent
SRC_DIR = APP_ROOT / "Jewellery icon"
OUT_DIR = APP_ROOT / "assets" / "jewelry_icons"
